        ...
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>S.S.Agrawal</p>
                    <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>dentalcare@gmail.com</p>
                    <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+91 8754875692</p>
                </div>
                <!-- <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-6 text-center text-md-start">
                    ...
                    <a class="text-white border-bottom" href="mainhome.php">Dental Health Care</a>. 
                    All Rights Reserved.
                </p>
                </div>
            </div>
